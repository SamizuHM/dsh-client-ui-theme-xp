...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			"/* Hidden with visibility (NOT display:none): the app's modal overlays",
			"   (settings panel etc.) render inside these columns, and display:none",
			"   on an ancestor makes even position:fixed descendants invisible —",
			"   the settings panel was opening fine but had a 0x0 rect. visibility",
			"   keeps the desktop clean while the explicit overlay rule shows",
			"   modals on top of the desktop. */",
